...
var bootbox = window.bootbox || (function(document, $) {
    ...
    that.dialog = function(str, handlers, options) {
        ...
        var parts = ["<div class='bootbox modal' role='dialog' aria-hidden='true' tabindex='-1' style='overflow:hidden;'>"];
        ...
        parts.push("</div>"); // dialog
        parts.push("</div>"); // content
        parts.push("</div>"); // modal
